...
class LyricsPane extends StatelessWidget {
  ...
  const LyricsPane({Key? key, this.lyrics}) : super(key: key);
...
class ArtistInfoPane extends StatelessWidget {
  ...
  const ArtistInfoPane({Key? key, required this.song, this.info}) : super(key: key);
...
class AlbumInfoPane extends StatelessWidget {
  ...
  const AlbumInfoPane({Key? key, required this.song, this.info}) : super(key: key);
